...
namespace Utils
{
    ...
    public class MonoBehaviourSingleton<T> : MonoBehaviour where T : MonoBehaviour
    {
        ...
        {
            Debug.LogWarning($"Duplicate instance of {typeof(T).Name} has been found on gameObject {gameObject.name}. DESTROYING!");
            Destroy(gameObject);
        }
        ...
        private void Awake()
        {
            ...
            else if (thisInstance != _instance && dontDestroyOnLoad)
            {
